...
<head>
    ...
    <title>Оборудование для улицы</title>
    ...
    <div id="page">
        ...
        <div id="crumbs">
            <div class="inner">
                ...
                <p class="link-crumbs"><?= $itemCat['NAME'] ?></p>
            </div>
        </div>

        <div id="name-category-block">
            <div class="inner">
                <div id="name-category-img-block" style="background-image: url('<?= $itemCat['BIGIMG'] ?>');">
                    <div class="name-category-text-block">
                        <h1 class="title-category"><?= $itemCat['NAME'] ?></h1>
                        <p class="text-category"><?= $itemCat['DESK'] ?></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div id="product-list">
                    ...
                    <div id="filter-block">
                        <form action="" id="filterForm" method="get">
                            <input value="<?= $idCat ?>" type="hidden" id="id-filter" name="catId">
                        ...
                        <form action="" method="get">
                            <input value="<?= $idCat ?>" type="hidden" id="id-clear" name="catId">
