    ...
    <div id="page">
        ...
        <div id="list-category">
            <div class="inner">
                ...
                <select class="add-input" name="status-order" id="status-order">
                    <option value="1" <?php if ($itemOrder['STATUS'] == 1) echo 'selected="selected"' ?>>В обработке</option>
                    <option value="2" <?php if ($itemOrder['STATUS'] == 2) echo 'selected="selected"' ?>>Собирается</option>
                    <option value="3" <?php if ($itemOrder['STATUS'] == 3) echo 'selected="selected"' ?>>В доставке</option>
                    <option value="4" <?php if ($itemOrder['STATUS'] == 4) echo 'selected="selected"' ?>>Выполнен</option>
                </select>
                <button type="button" class="button-add" onclick="updOrder(<?= $itemOrder['ID'] ?>)">
                    Изменить
                </button>
            </div>
        </div>
            ...
            <div class="inner">
                <div class="basket-table">
                    <table>
                        ...
                        <tbody>
                            <?php
                            addTableOrdersAdmin($OrdersItemList, $TableProdAll, $PhotosProdList, $idOrder);
                            ?>
                        </tbody>
                    </table>
                </div>
                <div class="char-basket-block">
                    ...
                    <a href="orders.php" class="button-add">
                        Назад
                    </a>
                </div>
            </div>
